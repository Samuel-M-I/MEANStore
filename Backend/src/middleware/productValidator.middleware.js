/**
 * validateProduct
 * Valida todos los campos obligatorios al crear un producto:
 * - name: obligatorio, entre 3 y 100 caracteres
 * - description: opcional, máximo 500 caracteres
 * - price: obligatorio, no puede ser negativo
 * - stock: obligatorio, entero no negativo
 * - category: obligatoria, debe ser del enum del modelo
 *
 * validateUpdateProduct
 * Valida solo los campos que se envíen al editar un producto.
 * No exige que ningún campo esté presente — solo verifica
 * que los campos enviados cumplan con las reglas de negocio.
 */
